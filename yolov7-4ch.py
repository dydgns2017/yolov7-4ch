...
!python train.py --workers 0 --device 0 --batch-size 8 --data test_dataset/data.yaml --img 640 640 --cfg yolov7-4ch.yaml --weights 'yolov7_training.pt' --name yolov7 --hyp data/hyp.scratch.p5.yaml --epoch 1
# %%
